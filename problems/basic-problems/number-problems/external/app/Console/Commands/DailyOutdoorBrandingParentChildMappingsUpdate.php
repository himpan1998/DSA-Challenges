...
class DailyOutdoorBrandingParentChildMappingsUpdate extends Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'daily:outdoor_branding_parent_child_mappings_update';
    protected $tableName = 'tbl_outdoor_branding_parent_child_mappings';
     ...
     * @var string
     */
    protected $description = 'Update/Insert data in tbl_outdoor_branding_parent_child_mappings table in power bi database';
