...
class DailyCampaignRequestedByAccountsUpdate extends Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'daily:campaign_requested_by_accounts_update';
    protected $tableName = 'tbl_campaign_requested_by_accounts';
     ...
     * @var string
     */
    protected $description = 'Update/Insert data in tbl_campaign_requested_by_accounts table in power bi database';
