...
class DailyOutdoorBrandingImagesUpdate extends Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'daily:outdoor_branding_images_update';
    protected $tableName = 'tbl_outdoor_branding_images';
    /**
     * The console command description.
     *
     * @var string
     */
    protected $description = 'Update/Insert data in tbl_outdoor_branding_images table in power bi database';
