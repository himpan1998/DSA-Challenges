...
class DailyDealerLedgersUpdate extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'daily:dealer_ledgers_update';
    protected $tableName = 'tbl_dealer_ledgers';
     ...
     * @var string
     */
    protected $description = 'Update/Insert data in tbl_dealer_ledgers table in power bi database';
