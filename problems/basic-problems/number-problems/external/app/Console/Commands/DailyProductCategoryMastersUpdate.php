...
class DailyProductCategoryMastersUpdate extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'daily:product_category_masters_update';
    protected $tableName = 'tbl_product_category_masters';
     ...
     * @var string
     */
    protected $description = 'Update/Insert data in tbl_product_category_masters table in power bi database';
