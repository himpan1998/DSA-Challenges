...
class DailyCampaignInviteListsUpdate extends Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'daily:campaign_invite_lists_update';
    protected $tableName = 'tbl_campaign_invite_lists';
     ...
     * @var string
     */
    protected $description = 'Update/Insert data in tbl_campaign_invite_lists table in power bi database';
