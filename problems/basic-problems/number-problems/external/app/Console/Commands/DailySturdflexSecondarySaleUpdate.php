...
class DailySturdflexSecondarySaleUpdate extends Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'daily:sturdflex_secondary_sale_update';
    protected $tableName = 'tbl_sturdflex_secondary_sales';
     ...
     * @var string
     */
    protected $description = 'Update/Insert data in tbl_sturdflex_secondary_sales table in power bi database';
