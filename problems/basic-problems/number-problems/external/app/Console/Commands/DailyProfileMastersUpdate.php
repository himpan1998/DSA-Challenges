...
class DailyProfileMastersUpdate extends Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'daily:profile_masters_update';
    protected $tableName = 'tbl_profile_masters';
     ...
     * @var string
     */
    protected $description = 'Update/Insert data in tbl_profile_masters table in power bi database';
