...
class DailySubdealerChemicalPurchasesUpdate extends Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'daily:subdealer_chemical_purchases_update';
    protected $tableName = 'tbl_subdealer_chemical_purchases';
     ...
     * @var string
     */
    protected $description = 'Update/Insert data in tbl_subdealer_chemical_purchases table in power bi database';
    ...
    public function handle() {
        ...
        $productionDatabaseData        = $CRM_DB_CONNECTION->table($this->tableName)->where('id', '>', $localDatabaseData->state_id)->get();
