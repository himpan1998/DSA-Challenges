...
class DailyOutdoorBrandingMasterUpdate extends Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'daily:outdoor_branding_master_update';
    protected $tableName = 'tbl_outdoor_branding_masters';
     ...
     * @var string
     */
    protected $description = 'Update/Insert data in tbl_outdoor_branding_masters table in power bi database';
