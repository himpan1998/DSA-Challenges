...
class DailyOutdoorBrandingDesignMastersUpdate extends Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'daily:outdoor_branding_design_masters_update';
    protected $tableName = 'tbl_outdoor_branding_design_masters';
     ...
     * @var string
     */
    protected $description = 'Update/Insert data in tbl_outdoor_branding_design_masters table in power bi database';
