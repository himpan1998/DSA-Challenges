...
class DailyBrandingRequisitionMasterUpdate extends Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'daily:branding_requisition_master_update';
    protected $tableName = 'tbl_branding_requisition_masters';
     ...
     * @var string
     */
    protected $description = 'Update/Insert data in tbl_branding_requisition_masters table in power bi database';
