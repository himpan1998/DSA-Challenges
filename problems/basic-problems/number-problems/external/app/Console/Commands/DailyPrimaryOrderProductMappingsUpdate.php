...
class DailyPrimaryOrderProductMappingsUpdate extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'daily:primary_order_product_mappings_update';
    protected $tableName = 'tbl_primary_order_product_mappings';
     ...
     * @var string
     */
    protected $description = 'Update/Insert data in tbl_primary_order_product_mappings table in power bi database';
