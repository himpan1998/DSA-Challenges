...
class DailyOutdoorBrandingLogsUpdate extends Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'daily:outdoor_branding_logs_update';
    protected $tableName = 'tbl_outdoor_branding_logs';
     ...
     * @var string
     */
    protected $description = 'Update/Insert data in tbl_outdoor_branding_logs table in power bi database';
