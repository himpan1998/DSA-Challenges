...
class DailyProductSkuMastersUpdate extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'daily:product_sku_masters_update';
    protected $tableName = 'tbl_product_sku_masters';
    /**
     * The console command description.
     *
     * @var string
     */
    protected $description = 'Update/Insert data in tbl_product_sku_masters table in power bi database';
