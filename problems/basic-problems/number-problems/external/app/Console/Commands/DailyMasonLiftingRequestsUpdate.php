...
class DailyMasonLiftingRequestsUpdate extends Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'daily:mason_lifting_requests_update';
    protected $tableName = 'tbl_mason_lifting_requests';
     ...
     * @var string
     */
    protected $description = 'Update/Insert data in tbl_mason_lifting_requests table in power bi database';
