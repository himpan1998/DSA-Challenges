...
class DailyUserMasterUpdate extends Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'daily:users_update';
     ...
     * @var string
     */
    protected $description = 'Update/Insert data in users table in power bi database';
