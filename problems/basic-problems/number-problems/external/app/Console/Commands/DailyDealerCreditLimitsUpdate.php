...
class DailyDealerCreditLimitsUpdate extends Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'daily:dealer_credit_limits_update';
    protected $tableName = 'tbl_dealer_credit_limits';
     ...
     * @var string
     */
    protected $description = 'Update/Insert data in tbl_dealer_credit_limits table in power bi database';
