...
class DailyPrimaryOrderMastersUpdate extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'daily:primary_order_masters_update';
    protected $tableName = 'tbl_primary_order_masters';
     ...
     * @var string
     */
    protected $description = 'Update/Insert data in tbl_primary_order_masters table in power bi database';
    ...
    public function handle()
    {
        ...
        if ($productionDatabaseUpdatedData->count() > 0) {
            ...
            foreach ($productionDatabaseUpdatedData as $data) {
                if (isset($data['payment_date']) && ($data['payment_date'] == '0000-00-00' || $data['payment_date'] == null)) {
