...
class DailyPrimaryLoadingProgramItemsUpdate extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'daily:primary_loading_program_items_update';
    protected $tableName = 'tbl_primary_loading_program_items';
     ...
     * @var string
     */
    protected $description = 'Update/Insert data in tbl_primary_loading_program_items table in power bi database';
