...
class DailyPrimaryOrderOverdueClearningPlansUpdate extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'daily:primary_order_over_due_clearing_plans_update';
    protected $tableName = 'tbl_primary_order_overdue_clearning_plans';
     ...
     * @var string
     */
    protected $description = 'Update/Insert data in tbl_primary_order_overdue_clearning_plans table in power bi database';
