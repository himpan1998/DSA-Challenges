...
class DailyPrimaryOrderLoadingProgramsUpdate extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'daily:primary_order_loading_programs_update';
    protected $tableName = 'tbl_primary_order_loading_programs';
     ...
     * @var string
     */
    protected $description = 'Update/Insert data in tbl_primary_order_loading_programs table in power bi database';
